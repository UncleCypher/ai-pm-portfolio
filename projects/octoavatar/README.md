...
- 目标用户：首次配置或更换 GitHub 头像、但不熟悉图片格式与压缩规则的用户
- 核心任务：无需学习技术规则，快速得到可以直接使用的头像文件
- 关键假设：自动处理格式与文件大小可以降低操作成本，本地处理可以降低隐私顾虑
- MVP 范围：选择图片、调整画面、预览 GitHub 圆形效果、导出合规 PNG
- 非目标：账号系统、云端素材库、社交头像生成与 AI 风格化
